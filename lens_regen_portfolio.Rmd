...
results <- boot(data = data, statistic = nb_maxima, R = 10000)
...
```
```{r}
# Plot the Graph with CI's included

# Define the Confidence Intervals
larvae_ci <- c(6.663540, 7.334681)
juvenile_ci <- c(10.13767, 10.79974)
adult_ci <- c(11.0610, 11.9189)
